...
module.exports = function () {
    ...
    app.use(session({
        secret: brahma.config.get('session_secret'),
        cookie: {maxAge:10800000 }, // 1 hour 3600000
        unset: 'destroy',
        resave: true,
        saveUninitialized: false,
        store: new mongoStore({
            db: brahma.mongoose.connection.db,
    ...
    app.use(morgan(':remote-addr - :remote-user ":method :url" :status ":message"', { "stream": brahma.logger.stream }));
    // debug logger
    ...
    require('../../app/routes/developer')(app);
