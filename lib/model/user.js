...
var
    ...
    Q = require('q'),
    filtered_fields = '_id username email password_change_needed approved device_type volume_id vm_ip vm_ip_id vm_id roles Status latency bandwidth email_id';
...
function ProxyModel(mongoose) {
    ...
    var email_id = crypto.randomBytes(32).toString('base64').replace(/[^a-z]+/g, '');
    ...
    /**
     * Get the User's vm ip
     * @returns {String} the vm ip
     */
    ProxyUserSchema.methods.getVmIp = function () {
        return this.vm_ip;
    };
    ...
    return mongoose.model('ProxyUsers', ProxyUserSchema);
}
