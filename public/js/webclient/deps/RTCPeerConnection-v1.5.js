...
// TURN Setting 
    if(chromeVersion <= 55) {
        iceServers = {
            "iceServers":[{url: 'turn:140.96.170.71:12433'}]};
    }
    else {
        iceServers = {
            "iceServers":[{url: 'turn:140.96.170.71:12433',
...
//            var tmp2 = tmp1.replace("a=fmtp:111 minptime=10\r\n","");
	      var tmp2 = tmp1.replace("a=fmtp:111 minptime=10\r\n","");
	      //var tmp3 = tmp2.replace(/UDP\/TLS\/RTP\/SAVPF/ig,"RTP/SAVPF");
	      var tmp4 = tmp2.replace("a=rtcp-fb:111 transport-cc\r\n","");
	      var tmp5 = tmp4.replace("111 103","103");
	      var tmp6 = tmp5.replace("a=fmtp:111 minptime=10;useinbandfec=1\r\n","");
            sessionDescription.sdp = tmp6;
